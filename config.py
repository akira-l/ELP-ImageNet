...
if os.path.exists('../../data/pretrain_model'):
    pretrained_model = {'resnet50' : '../../data/pretrain_model/resnet50-19c8e357.pth',
                        'resnet101': '../../data/pretrain_model/resnet101-63fe2227.pth',
                        'resnet152': '../../data/pretrain_model/resnet152-b121ed2d.pth',
                        'resnext50_32x4d': '../../data/pretrain_model/resnext50_32x4d-7cdf4587.pth', 
                        'resnext101_32x8d': '../../data/pretrain_model/resnext101_32x8d-8ba56ff5.pth',
...
class LoadConfig(object):
    def __init__(self, args, version):
        ...
        if args.dataset == 'CUB':
            self.dataset = args.dataset
            self.rawdata_root = './../dataset/CUB_200_2011/dataset/data'#'/user/PUBLIC_KM_Data/dataset/CUB_200_2011/dataset/data'
            if not os.path.exists(self.rawdata_root):
                self.rawdata_root = './CUB_200_2011/dataset/data'
            self.anno_root = './../dataset/CUB_200_2011/dataset/anno'#'/user/PUBLIC_KM_Data/dataset/CUB_200_2011/dataset/anno'
            if not os.path.exists(self.anno_root):
                self.anno_root = './CUB_200_2011/dataset/anno'
            self.numcls = 200

        if args.dataset == 'imagenet':
            self.dataset = args.dataset
            self.rawdata_root = '../../data'
            self.anno_root = '../../data/imagenet_anno'
            self.numcls = 1000
        ...
        self.use_pretrained = False if args.ignore_pretrained else True 
