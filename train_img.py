...
def parse_args():
    ...
    parser.add_argument('--save', dest='resume',
                        default='./net_model/_102212_imagenet/weights__base__83_2502_0.7661_0.9005.pth', 
                        #'./net_model/_92716_imagenet/weights__base__33_1251_0.7618_0.8937.pth',
                        type=str)
...
if __name__ == '__main__':
    ...
    simple_cls_ratio = 10
    cls_base_lr = min(lr_ratio * base_lr, 0.1) 
    ...
    filter_optim = optim.SGD([
                               {'params': ddp_as_model.module.parameters(), 'lr': 0.01},
                               #{'params': ddp_as_model.parameters(), 'lr': 0.01},

                              ], lr = base_lr*base_lr, momentum=0.9)
    ...
    #filter_exp_lr_scheduler = lr_scheduler.MultiStepLR(filter_optim, milestones=[300], gamma=0.1)
