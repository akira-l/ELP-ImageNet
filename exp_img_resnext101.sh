...
log_name="resnext101_div_sum-ver_gamma2_init2_alpha05_lr0002-${time_stamp}.log"


nohup python train_img.py --tb 200 --lr 0.002 --alpha 0.5 --backbone resnext101_32x8d > ${log_name} 2>&1 & 
